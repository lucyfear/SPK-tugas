...
// Prevent access to dashboard (index) if already logged in
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/img/SMAN3_Pinrang.ico">
                            ...
                            <div class="col-lg-6 d-none d-lg-flex bg-login-image align-items-center justify-content-center">
                                <div class="row justify-content-center">
                                    <div class="col-3 d-flex justify-content-center align-items-center p-0">
                                      <img src="assets/img/SMAN3_Pinrang.png" alt="SMAN3_Pinrang" title="SMAN3_Pinrang" class="logo">  
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-4 p-sm-5 p-md-5 p-lg-5 p-xl-5">
                                    <div class="text-center">
                                        <img src="assets/img/SMAN3_Pinrang.png" alt="SMAN3_Pinrang" title="SMAN3_Pinrang" class="logo d-lg-none mb-2">
                                        ...
                                        <!-- <img src="assets/img/SMAN3_Pinrang.png" alt="" class="img-profile w-25"> -->
                                    </div>
